...
public class Client implements ActionListener{
    ...
    Client(){
         ...
         JLabel morevert = new JLabel(i15)    ;
          ...
          JLabel sts = new JLabel("Active Now");
          sts.setBounds(110,45,100,18);
          sts.setForeground(Color.WHITE);
          sts.setFont(new Font("San_Serif",Font.BOLD,13));
          p1.add(sts);
          
          a1 = new JPanel();
          a1.setBounds(0,75,450,570);
          f.add(a1);
          
          text = new JTextField();
          text.setBounds(2,646,350,50);
          text.setFont(new Font("SAN_SERIF",Font.PLAIN,16));
          f.add(text);
          
          JButton send = new JButton("Send");
          send.setBounds(363,646,70,50);
...
//        System.out.println(out);
    ...
    public static void main(String[] args){
        ...
        try{
           ...
           DataInputStream din = new DataInputStream(s.getInputStream());//msg receive
